defmodule HgWeb.Components.Hero do
    ...
    <div class={["container mx-auto max-w-4xl py-32 sm:py-48 lg:py-56", @class]}>
      <div class="hidden sm:mb-8 sm:flex sm:justify-center">
        <div
          ...
          class="ring-gray-900/10 relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 hover:ring-gray-900/20 dark:text-gray-300"
        >
          <%= render_slot(@announcement_badge) %>
        </div>
      </div>
      <div class="text-pretty text-center text-6xl font-bold tracking-tight text-gray-900 dark:text-gray-100">
        <h1><%= render_slot(@inner_block) %></h1>
      </div>
      <div class="text-pretty mt-6 flex justify-center text-center text-lg font-medium leading-8 text-gray-600 dark:text-gray-300">
