defmodule HgWeb.Components.BentoGrid do
  ...
  attr(:row_end, :integer, default: 2)
  ...
  def bento_card(assigns) do
    ...
    <div class={[
      ...
      <div class="absolute bottom-0 flex w-full translate-y-10 transform-gpu flex-row items-center p-4 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100 dark:text-neutral-200">
        <%= render_slot(@inner_block) %>
      </div>
